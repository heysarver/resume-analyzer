...
def analyze_resume(resume_text):
    ...
    prompt = f"Analyze the following resume in 500 characters or less.  Then, based only on the data in the resume and without any assumptions, make a conculsion if this is a potential candidate for a Site Reliability Engineer: {resume_text}"
